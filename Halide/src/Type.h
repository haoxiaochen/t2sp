...
public:
    ...
    HALIDE_ALWAYS_INLINE
    int lanes() const {
//    debug(4) << ".....typelanes=" << type.lanes << "\n";
        internal_assert(type.lanes > 0);
        return type.lanes;
    }
    ...
    bool is_vector() const {
        return lanes() != 1 || is_generated_vector();
    }
    ...
    /** Is this type actually a vector generated by the compiler?
     *  See VectorType.h for details. */
    bool is_generated_vector() const;
