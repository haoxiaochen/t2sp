...
int main()
{
    ...
    // TODO: Enable JJJ and KKK as symbolic constants. Currently, they are static constants due to some restrictions in the vectorization phase of the compiler.                                                                                                                                           
    SymbolicConstant<int> III("III", 1, 100)/*, JJJ("JJJ", 1, 100), KKK("KKK", 1, 100)*/; // Positive constants, any integer values within [1, 100].
