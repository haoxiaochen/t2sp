 ...
 __address_space__P_serializer_mem_channel const float *restrict _P_serializer_mem_channel)
{
 ...
 {
  for (int _PLoader_s0_mk_ci_kx_ky_mx_y_x_yyy_xxx = 0; _PLoader_s0_mk_ci_kx_ky_mx_y_x_yyy_xxx < 0 + 14400; _PLoader_s0_mk_ci_kx_ky_mx_y_x_yyy_xxx++)
  {
   int _1 = _addr_temp;
   int _2 = _1 * 16;
 ...
 const int _P_extent_1)
{
 ...
 float16 __attribute__((memory, numbanks(16), singlepump)) _PFeeder_DB_0_ibuffer[2][3][3][4][5][16];
 #pragma unroll
 for (int _PFeeder_s0_cooo_init = 0; _PFeeder_s0_cooo_init < 0 + 8; _PFeeder_s0_cooo_init++)
 {
  ...
  if (_5)
  {
   uint _6 = (uint)(ADD_UINT64_T_SUFFIX(1080));
 ...
 {
  uint _10 = (uint)(ADD_UINT64_T_SUFFIX(1080));
  uint _11 = _PFeeder_cycle_temp;
  uint _12 = (uint)(ADD_UINT64_T_SUFFIX(2880));
  uint _13 = _11 % _12;
  bool _14 = _10 <= _13;
  uint _15 = _11 / _12;
  int _16 = (int)(_15);
  ...
  for (int _PFeeder_s0_buf = 0; _PFeeder_s0_buf < 0 + 10; _PFeeder_s0_buf++)
  {
   ...
   (void)_34;
   uint _35 = (uint)(ADD_UINT64_T_SUFFIX(1080));
   uint _37 = _PFeeder_time_stamp_shreg;
   uint _38 = (uint)(ADD_UINT64_T_SUFFIX(2880));
   uint _39 = _37 % _38;
   bool _40 = _35 <= _39;
   if (_40)
   {
    uint _42 = _PFeeder_time_stamp_shreg;
    uint _43 = (uint)(ADD_UINT64_T_SUFFIX(2880));
    uint _44 = _42 % _43;
    uint _45 = (uint)(ADD_UINT64_T_SUFFIX(1080));
    uint _46 = _44 - _45;
    ...
    if (_50)
    {
     ...
     uint _55 = (uint)(ADD_UINT64_T_SUFFIX(2880));
     uint _56 = _54 / _55;
     uint _57 = (uint)(ADD_UINT64_T_SUFFIX(1));
     uint _58 = _56 & _57;
     bool _59 = (bool)(_58);
     uint _61 = _54 % _55;
     uint _62 = (uint)(ADD_UINT64_T_SUFFIX(1080));
     uint _63 = _61 - _62;
     int _64 = (int)(_63);
     int _65 = _64 / 600;
     int _67 = _64 / 200;
   ...
   uint _77 = (uint)(ADD_UINT64_T_SUFFIX(2880));
   uint _78 = _76 / _77;
   int _79 = (int)(_78);
   ...
   if (_86)
   {
    ...
    uint _89 = (uint)(ADD_UINT64_T_SUFFIX(2880));
    uint _90 = _88 / _89;
  ...
  uint _110 = (uint)(ADD_UINT64_T_SUFFIX(2880));
  uint _111 = _109 / _110;
  int _112 = (int)(_111);
 ...
 const int _P_extent_1)
{
 ...
 for (int _WFeeder_s0_yyy_xxx_init = 0; _WFeeder_s0_yyy_xxx_init < 0 + 10; _WFeeder_s0_yyy_xxx_init++)
 {
  ...
  if (_129)
  {
   uint _130 = (uint)(ADD_UINT64_T_SUFFIX(1728));
 ...
 {
  uint _134 = (uint)(ADD_UINT64_T_SUFFIX(1728));
  uint _135 = _WFeeder_cycle_temp;
  uint _136 = (uint)(ADD_UINT64_T_SUFFIX(2880));
  uint _137 = _135 % _136;
  bool _138 = _134 <= _137;
  uint _139 = _135 / _136;
  int _140 = (int)(_139);
  ...
  for (int _WFeeder_s0_buf = 0; _WFeeder_s0_buf < 0 + 8; _WFeeder_s0_buf++)
  {
   ...
   (void)_158;
   uint _159 = (uint)(ADD_UINT64_T_SUFFIX(1728));
   uint _161 = _WFeeder_time_stamp_shreg;
   uint _162 = (uint)(ADD_UINT64_T_SUFFIX(2880));
   uint _163 = _161 % _162;
   bool _164 = _159 <= _163;
   if (_164)
   {
    uint _166 = _WFeeder_time_stamp_shreg;
    uint _167 = (uint)(ADD_UINT64_T_SUFFIX(2880));
    uint _168 = _166 % _167;
    uint _169 = (uint)(ADD_UINT64_T_SUFFIX(1728));
    uint _170 = _168 - _169;
    ...
    if (_174)
    {
     ...
     uint _179 = (uint)(ADD_UINT64_T_SUFFIX(2880));
     uint _180 = _178 / _179;
     uint _181 = (uint)(ADD_UINT64_T_SUFFIX(1));
     uint _182 = _180 & _181;
     bool _183 = (bool)(_182);
     uint _185 = _178 % _179;
     uint _186 = (uint)(ADD_UINT64_T_SUFFIX(1728));
     uint _187 = _185 - _186;
     int _188 = (int)(_187);
     int _189 = _188 / 384;
     int _191 = _188 >> 7;
   ...
   uint _201 = (uint)(ADD_UINT64_T_SUFFIX(2880));
   uint _202 = _200 / _201;
   int _203 = (int)(_202);
   ...
   if (_210)
   {
    ...
    uint _213 = (uint)(ADD_UINT64_T_SUFFIX(2880));
    uint _214 = _212 / _213;
  ...
  uint _235 = (uint)(ADD_UINT64_T_SUFFIX(2880));
  uint _236 = _234 / _235;
  int _237 = (int)(_236);
...
{
 // produce C
 float _C_shreg[320][8][10];
 float _C_pipe_shreg[8][2881];
 // produce B
 float16 _B_shreg[8];
 float _C_temp[8][10];
 // produce A
 ...
 _C_pipe_iter_temp = 3200;
 _C_pipe_base_temp = 0;
 int _248 = _P_extent_1 / 225;
 int _249 = _248 * 8;
 int _250 = _249 + 1;
 for (int _A_s0_n_mk_ci = 0; _A_s0_n_mk_ci < 0 + _250; _A_s0_n_mk_ci++)
 {
  for (int _A_s0_kx_ky_coo_mx_my_y_x = 0; _A_s0_kx_ky_coo_mx_my_y_x < 0 + 2880; _A_s0_kx_ky_coo_mx_my_y_x++)
  {
   #pragma unroll
   for (int _dummy__1_s0_yyy_xxx = 0; _dummy__1_s0_yyy_xxx < 0 + 10; _dummy__1_s0_yyy_xxx++)
   {
    ...
    {
     float _252 = _C_shreg[319][_dummy_s0_cooo][_dummy__1_s0_yyy_xxx];
     _C_temp[_dummy_s0_cooo][_dummy__1_s0_yyy_xxx] = _252;
     #pragma unroll
     for (int _dummy__2_s0_l1 = 0; _dummy__2_s0_l1 < 0 + 319; _dummy__2_s0_l1++)
     {
      int _253 = 319 - _dummy__2_s0_l1;
      int _254 = 318 - _dummy__2_s0_l1;
   ...
   for (int _A_s0_yyy_xxx = 0; _A_s0_yyy_xxx < 0 + 10; _A_s0_yyy_xxx++)
   {
    ...
    for (int _A_s0_cooo = 0; _A_s0_cooo < 0 + 8; _A_s0_cooo++)
    {
     ...
     (void)_280;
     float _281;
     int _282 = _A_s0_kx_ky_coo_mx_my_y_x / 960;
     bool _283 = _282 == 0;
     int _284 = _A_s0_kx_ky_coo_mx_my_y_x % 960;
     int _285 = _284 / 320;
     bool _286 = _285 == 0;
     bool _287 = _283 && _286;
     int _288 = _A_s0_n_mk_ci & 7;
     int _289 = _288 >> 1;
     bool _290 = _289 == 0;
     bool _291 = _287 && _290;
     int _292 = _A_s0_n_mk_ci & 1;
     bool _293 = _292 == 0;
     bool _294 = _291 && _293;
     if (_294)
     {
     ...
     for (int _A_s0_cii = 0; _A_s0_cii < 0 + 16; _A_s0_cii++)
     {
      ...
      int _313 = _A_s0_n_mk_ci & 1;
      bool _314 = _313 == 1;
      bool _315 = _312 && _314;
      int _316 = _A_s0_n_mk_ci & 7;
      int _317 = _316 >> 1;
      bool _318 = _317 == 3;
      bool _319 = _315 && _318;
      int _320 = _A_s0_kx_ky_coo_mx_my_y_x % 960;
      int _321 = _320 / 320;
      bool _322 = _321 == 2;
      bool _323 = _319 && _322;
      int _324 = _A_s0_kx_ky_coo_mx_my_y_x / 960;
      bool _325 = _324 == 2;
      bool _326 = _323 && _325;
      if (_326)
      {
       int _327 = _A_s0_yyy_xxx * 320;
   ...
   int _330 = _A_s0_kx_ky_coo_mx_my_y_x % 5;
   bool _331 = _330 == 0;
   int _332 = _A_s0_kx_ky_coo_mx_my_y_x % 20;
   int _333 = _332 / 5;
   bool _334 = _333 == 0;
   bool _335 = _331 && _334;
   int _336 = _A_s0_kx_ky_coo_mx_my_y_x % 80;
   int _337 = _336 / 20;
   bool _338 = _337 == 0;
   bool _339 = _335 && _338;
   int _340 = _A_s0_kx_ky_coo_mx_my_y_x % 320;
   int _341 = _340 / 80;
   bool _342 = _341 == 0;
   bool _343 = _339 && _342;
   int _344 = _A_s0_kx_ky_coo_mx_my_y_x / 960;
   bool _345 = _344 == 2;
   bool _346 = _343 && _345;
   int _347 = _A_s0_kx_ky_coo_mx_my_y_x % 960;
   int _348 = _347 / 320;
   bool _349 = _348 == 2;
   bool _350 = _346 && _349;
   int _351 = _A_s0_n_mk_ci & 7;
   int _352 = _351 >> 1;
   bool _353 = _352 == 3;
   bool _354 = _350 && _353;
   int _355 = _A_s0_n_mk_ci & 1;
   bool _356 = _355 == 1;
   bool _357 = _354 && _356;
   if (_357)
   {
   ...
   #pragma unroll
   for (int _C_pipe_b__62 = 0; _C_pipe_b__62 < 0 + 8; _C_pipe_b__62++)
   {
    float _360 = _C_pipe_shreg[_C_pipe_b__62][0];
    _Out_unloader_channel_temp[_C_pipe_b__62] = _360;
    #pragma unroll
    for (int _C_pipe_b__62_dummy = 0; _C_pipe_b__62_dummy < 0 + 8; _C_pipe_b__62_dummy++)
    {
     float _361 = _Out_unloader_channel_temp[_C_pipe_b__62_dummy];
     float _362 = __fpga_reg(__fpga_reg(_361));
     _Out_unloader_channel_temp[_C_pipe_b__62_dummy] = _362;
    } // for _C_pipe_b__62_dummy
   } // for _C_pipe_b__62
   ...
   #pragma unroll
   for (int _C_pipe_b__63 = 0; _C_pipe_b__63 < 0 + 8; _C_pipe_b__63++)
   {
    #pragma unroll
    for (int _C_pipe_p__31 = 0; _C_pipe_p__31 < 0 + 9; _C_pipe_p__31++)
    {
     #pragma unroll
     for (int _C_pipe_l__31 = 0; _C_pipe_l__31 < 0 + 319; _C_pipe_l__31++)
     {
      int _368 = _C_pipe_p__31 * 320;
      int _369 = _368 + _C_pipe_l__31;
      int _370 = _369 + 1;
      float _372 = _C_pipe_shreg[_C_pipe_b__63][_370];
      _C_pipe_shreg[_C_pipe_b__63][_369] = _372;
      (void)_372;
     } // for _C_pipe_l__31
     int _373 = _C_pipe_p__31 * 320;
     int _374 = _373 + 319;
     int _375 = _373 + 320;
     float _377 = _C_pipe_shreg[_C_pipe_b__63][_375];
     float _378 = __fpga_reg(__fpga_reg(_377));
     _C_pipe_shreg[_C_pipe_b__63][_374] = _378;
     (void)_378;
    } // for _C_pipe_p__31
   } // for _C_pipe_b__63
 ...
 __address_space__unloader_mem_channel float *restrict _unloader_mem_channel)
{
 ...
 {
  for (int _unloader_s0_yyy_xxx_coo_mx_my_y_x = 0; _unloader_s0_yyy_xxx_coo_mx_my_y_x < 0 + 3200; _unloader_s0_yyy_xxx_coo_mx_my_y_x++)
  {
